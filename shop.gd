...
func getItemData(playerId):
	return shopShelves[currentlySelected[playerId][0]][currentlySelected[playerId][1]]

func reselect(playerId):
	shopShelves[currentlySelected[playerId][0]][currentlySelected[playerId][1]].child.set_selected(false, playerId)
	currentlySelected[playerId] = PlayerSelections[playerId].duplicate()
	shopShelves[currentlySelected[playerId][0]][currentlySelected[playerId][1]].child.set_selected(true, playerId)
